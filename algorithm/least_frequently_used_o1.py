...
class FreqNode(DoublyLinkedList, Node):
    """Frequency node containing linked list of item nodes with same frequency."""
    ...
    def remove_item_node_by_data(self, data):
        self.remove_item_node_by_data(data)
...
class Cache(DoublyLinkedList):
    ...
    def insert(self, key, value):
        ...
        if not freq_node or freq_node.data != 1:
            freq_node = self.insert_freq_node(1, Node, freq_node)
