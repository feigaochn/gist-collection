#!/usr/bin/python
# Safari Reading List to Markdown
# Code from <https://gist.github.com/robmathers/5995026>
...
BOOKMARKS_MARKDOWN_FILE = '~/Bookmarks.markdown' # Markdown file if using md export
...
_readingList(DEFAULT_EXPORT_TYPE)
